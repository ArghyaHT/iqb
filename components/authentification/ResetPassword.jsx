            ...
            <main className={styles.resetpassword}>
                ...
                <div className={styles.right}>
                    <div className={styles.right_inner_container}>
                        ...
                        <p className={styles.divfour}><Link href="/signin" style={{color:"black",textDecoration:"none"}}><strong>Back to sign in</strong></Link></p>

                        <p className={styles.divfive}>Don't have an account? <Link href="/signup" style={{textDecoration:"none",color:"black"}}><strong>Sign Up</strong></Link></p>
